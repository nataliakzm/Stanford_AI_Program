...
File: Util
----------
This file contains several helper methods and a Belief class.
...
# -------------------------
# Saves the transition probabilities that have been generated by running "learner." 
def saveTransProb(transDict, transFile):
    pickle.dump(transDict, transFile)

# Function: Load Trans Prob
# -------------------------
# Loads the transition probabilities that have been generated by running "learner." 
def loadTransProb():
...
# car. It has one belief value for every tile on the map. 
class Belief(object):
    ...
    # Function: Add Prob
    # ------------------
    # Increase the probability of row, col by delta.
